...
import { grantLearningGrowth, grantResonanceMilestone, getSpiritGrowth } from '../app/game/growth.ts';
...
save.exploration = 22;
save.sightings = 2;
assert(isEpisodeUnlocked(save, 5), 'EP05 should unlock after EP04 and exploration 22');

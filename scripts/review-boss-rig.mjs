...
for(const [name, Component, assets, joint, pivot, angles, dimensions] of [
  ['boss',BossCaster,['gatekeeper.png','gatekeeper-seam-source.png'],'bu-boss-arm','184,643',[0,8,38,84,135],[512,768]],
...
console.log('Boss 0/8/38/84/135 and ally 38/95/112 degree asset poses rendered.');

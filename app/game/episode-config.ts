...
export const EPISODE_CONFIG: Readonly<Record<EpisodeId, EpisodeConfig>> = {
  1: {
    ...
    tier: 'main',
    unlock: {},
    narrativeSceneIds: ['ep01.opening_after_selection'],
    interactionIds: ['ep01.first_learning_pack'],
    hasBattle: false,
    hasBoss: false,
  ...
  2: {
    ...
    narrativeSceneIds: ['ep02.old_road'],
    interactionIds: ['ep02.old_road_observation'],
    hasBattle: false,
    hasBoss: false,
  ...
  3: {
    ...
    narrativeSceneIds: ['ep03.awakening_gate'],
    interactionIds: ['ep03.gate_interaction'],

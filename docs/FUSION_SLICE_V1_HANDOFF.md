...
| wordId | word | 正式显示义 | battleEligible 条件 | 测试技能 |
| --- | --- | --- | --- | --- |
| w1718 | water | 水 | 零基础证据达到 Used/Maintained | 澜歌·水音 |
| w729 | help | 帮助 | 零基础证据达到 Used/Maintained | 澜歌·回潮 |

...
主要风险：两张关键帧之间仍依靠快速转场遮接，非连续完整身体动作；深蓝不透明图底在特殊屏幕可能看到轻微色差，已用运行时边缘遮罩衔接；低端微信环境、移动GPU与动态体验尚未测。本轮到单招样板结束，不扩其他角色/技能，不继续数值平衡。

## 发布记录

- 实现315bf83aacb2755182c5341d36a90d391c0a8d01；部署源083550043f6e19ec8d11cf378f28ccfac14ac23d（仅额外清理文档末尾空行，运行代码相同）。GitHub与Sites source均已推送该源。
- 由该精确源重新build并打包32,696,320字节/139文件归档。
- Site版本33；version_id：appgprj_6a8b08d481fc819185986f60235ed2d1~appgver_266040c1c9f48191b164101d583b0aaa。
- deployment_id：appgdep_6a95052c24388191bc5757ce1dec03f7；2026-08-31T04:38:19Z查询为succeeded。
- 私有权限保持custom、仅owner一人、无群组/外部分享，本轮未修改权限。
- URL：https://word-spirit-civilization-demo.eeevan137.chatgpt.site/prototype/battle-ui。
- 此发布记录是部署后的纯文档补充，不改变已发布运行包。
